...
export default function FinalCTA() {
  return (
    <section id="about" className="relative overflow-hidden bg-[#0d1520] py-[120px]">
      ...
      <div className="relative z-[1] mx-auto max-w-[700px] px-10 text-center">
        ...
        <h2 className="mb-5 text-[clamp(36px,5vw,52px)] font-extrabold leading-[1.05] tracking-[-0.03em]">
          Start exploring <span className="gradient-text">now.</span>
        </h2>
        <p className="mb-10 text-base leading-[1.7] text-[#64748b]">
